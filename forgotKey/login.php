...
<form action="process.php" method="POST">
  ...
  <div class="container">
    ...
    <button type="submit" name="acceso">Login</button>
  
  </div>

  <div class="container" style="background-color:#f1f1f1">
    <button id="back" type="button" class="cancelbtn">Cancel</a></button>
    <button id="signup" type="button" class="signbtn">Signup</a></button>
